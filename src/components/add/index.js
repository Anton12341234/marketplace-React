...
import {actioCreateAd,origUrl,history} from '../../App.js';
    ...
    <main className="mainAdd">
        ...
        <div className="imd__flex__boxx">
                <Dnd items={createAd.images||[]} render={localPostImage} itemProp="image" keyField="_id"
                    onChange={newArray=>setCreate({...createAd,images: newArray})} //ставлю место консоль лога это: setSortImgArr(newArray)
                    horizontal/>
              </div>
